...
const styles = StyleSheet.create({
  ...
  typeLabel: { fontSize: FontSize.xs, fontWeight: FontWeight.bold },
  mistakeActions: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm },
  accuracyText: { fontSize: FontSize.xs, color: Colors.textMuted, fontWeight: FontWeight.semibold },
  masterBtn: { padding: 4 },
  mistakeTexts: { gap: 8 },
  ...
  originalText: { flex: 1, fontSize: FontSize.sm, color: Colors.error, textDecorationLine: 'line-through', lineHeight: 20 },
  correctedText: { flex: 1, fontSize: FontSize.sm, color: Colors.success, fontWeight: FontWeight.bold, lineHeight: 20 },
  expandedContent: { gap: 8, paddingTop: 8, borderTopWidth: 1, borderTopColor: Colors.border },
  ...
  progressText: { fontSize: FontSize.xs, color: Colors.textMuted, textAlign: 'right', fontWeight: FontWeight.medium },
  questionCard: {},
  questionLabelRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  questionLabel: { fontSize: FontSize.xs, color: Colors.textMuted, fontWeight: FontWeight.medium },
  ...
  explanationCardText: { flex: 1, fontSize: FontSize.sm, color: Colors.textSecondary, lineHeight: 20 },
  ...
  quizResultTitle: { fontSize: FontSize.xxl, fontWeight: FontWeight.extrabold, color: Colors.textPrimary, letterSpacing: -0.3 },
  quizResultScore: { fontSize: FontSize.lg, color: Colors.textSecondary, fontWeight: FontWeight.medium },
  quizResultPercent: { fontSize: 52, fontWeight: FontWeight.extrabold, letterSpacing: -2 },
