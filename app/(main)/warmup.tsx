...
const styles = StyleSheet.create({
  ...
  flipChipActive: { backgroundColor: Colors.primary, shadowColor: Colors.primary, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.35, shadowRadius: 4, elevation: 2 },
  flipChipText: { fontSize: FontSize.sm, color: Colors.textMuted, fontWeight: FontWeight.semibold },
  flipChipTextActive: { color: '#fff', fontWeight: FontWeight.bold },

  progressRow: { gap: Spacing.xs },
  progressRight: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: 6 },
  progressBar: { height: 5, backgroundColor: Colors.backgroundCard, borderRadius: 3, overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: 3 },
  progressText: { fontSize: FontSize.xs, color: Colors.textMuted, fontWeight: FontWeight.medium },
  aiCardBadge: {
  ...
  phraseJaMain: { fontSize: FontSize.xxl, fontWeight: FontWeight.extrabold, color: Colors.textPrimary, lineHeight: 38, letterSpacing: 0.3 },
  phraseCard: {
    borderRadius: BorderRadius.xl, padding: Spacing.xl, gap: Spacing.md,
    shadowColor: '#000',
  ...
  phraseCardBadge: {
    ...
    alignSelf: 'flex-start', backgroundColor: 'rgba(79,70,229,0.28)',
  ...
  phraseCardBadgeText: { color: Colors.primaryLight, fontSize: FontSize.xs, fontWeight: FontWeight.bold },
  phraseEnglish: { fontSize: FontSize.xxl, fontWeight: FontWeight.extrabold, color: Colors.textPrimary, lineHeight: 38, letterSpacing: -0.3 },
  hintRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  pronunciationHint: { fontSize: FontSize.sm, color: Colors.textSecondary, fontStyle: 'italic' },
  translateButton: {
    backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: BorderRadius.lg,
    padding: Spacing.md, minHeight: 60, justifyContent: 'center',
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)',
  },
  phraseJapanese: { fontSize: FontSize.xl, color: Colors.textPrimary, textAlign: 'center', lineHeight: 30 },
  ...
  exampleContext: { flex: 1, fontSize: FontSize.sm, color: Colors.textSecondary, fontStyle: 'italic', lineHeight: 20 },
  speakButton: {
    flexDirection: 'row', alignItems: 'center', gap: Spacing.sm,
    backgroundColor: Colors.primary, borderRadius: BorderRadius.lg,
    paddingVertical: 14, paddingHorizontal: Spacing.md, justifyContent: 'center',
  ...
  speakButtonText: { color: '#fff', fontSize: FontSize.md, fontWeight: FontWeight.bold },
