...
const styles = StyleSheet.create({
  ...
  periodText: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.55)', fontWeight: FontWeight.medium },
  periodTextActive: { color: '#fff', fontWeight: FontWeight.bold },
  ...
  overviewIconWrap: { width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  overviewValue: { fontSize: FontSize.xxl, fontWeight: FontWeight.extrabold, color: '#fff', letterSpacing: -0.5 },
  overviewLabel: { fontSize: FontSize.xs, color: 'rgba(255,255,255,0.7)', fontWeight: FontWeight.medium },

  /* Charts */
  chartCard: { gap: Spacing.md },
  chartTitleRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm },
  chartTitle: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: Colors.textPrimary, letterSpacing: -0.2 },
  barChart: { flexDirection: 'row', alignItems: 'flex-end', height: 120, gap: 3 },
  barColumn: { flex: 1, alignItems: 'center', gap: 4 },
  barWrapper: { flex: 1, justifyContent: 'flex-end', width: '75%' },
  ...
  weekMinutes: { fontSize: FontSize.xs, color: Colors.textSecondary, fontWeight: FontWeight.medium },
  weekMasteredRow: { flexDirection: 'row', alignItems: 'center', gap: 2 },
  weekMasteredText: { fontSize: 10, color: Colors.success, fontWeight: FontWeight.semibold },

  /* Distribution */
  distributionList: { gap: Spacing.sm },
  distributionRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm },
  distributionLeft: { flexDirection: 'row', alignItems: 'center', gap: 6, width: 62 },
  distributionDot: { width: 10, height: 10, borderRadius: 5 },
  distributionLabel: { fontSize: FontSize.xs, color: Colors.textSecondary, fontWeight: FontWeight.medium },
  ...
  distributionCount: { fontSize: FontSize.xs, color: Colors.textMuted, width: 36, textAlign: 'right', fontWeight: FontWeight.semibold },
  ...
  suggestionTitle: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: Colors.textPrimary, letterSpacing: -0.2 },
